...
public class BugzillaSetup {
	...
	public static ConfigBugChangePoliciesPage gotoConfigBugChangePoliciesPage (){
		checkDriver();
		checkLogin();
		
		driver.get(baseUrl + "/editparams.cgi?section=bugchange");
	...
	public static void setTestConfig() {
		...
		// Teclo-14-DuplicateormovebugstatusVerified
		ConfigBugChangePoliciesPage configBugChangePoliciesPage = gotoConfigBugChangePoliciesPage();
		configBugChangePoliciesPage.setDuplicateOrMoveBugStatus("VERIFIED");
	...
	public static void resetTestConfig() {
		...
		// Teclo-14-DuplicateormovebugstatusVerified
		ConfigBugChangePoliciesPage configBugChangePoliciesPage = gotoConfigBugChangePoliciesPage();
		configBugChangePoliciesPage.setDuplicateOrMoveBugStatus("RESOLVED");
