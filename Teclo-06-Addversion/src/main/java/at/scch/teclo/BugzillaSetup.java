...
import at.scch.teclo.pageobjects.AddVersionPage;
...
import at.scch.teclo.pageobjects.DeleteVersionPage;
...
public class BugzillaSetup {
	...
	public static AddVersionPage gotoAddVersionPage(String productName){		
		checkDriver();
		checkLogin();
		
		driver.get(baseUrl + "/editversions.cgi?action=add&product=" + productName);
		return PageFactory.initElements(driver, AddVersionPage.class);
	}
	
	public static DeleteVersionPage gotoDeleteVersionPage(String productName, String versionName){		
		checkDriver();
		checkLogin();
		
		driver.get(baseUrl + "/editversions.cgi?action=del&product=" + productName + "&version=" + versionName);
	...
	public static void setTestConfig() {
		...
		AddVersionPage addVersionPage = gotoAddVersionPage("TestProduct");
		addVersionPage.addVersion("TestVersion");
	...
	public static void resetTestConfig() {
		...
		DeleteVersionPage deleteVersionPage = gotoDeleteVersionPage("TestProduct", "TestVersion");
		deleteVersionPage.deleteVersion();
