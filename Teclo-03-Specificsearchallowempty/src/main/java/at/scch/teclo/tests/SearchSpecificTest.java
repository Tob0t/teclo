...
public class SearchSpecificTest extends AbstractBugzillaTestWithLogin {
	...
	/**
	 * Leave or rewrite for this setup?
	 */
	/*@Test
	...
	public void testSearchEmptyResultsInMatchingAll() {
		...
		SearchResultsPage searchResultsPage = searchSpecificPage.searchFor("");

		assertTrue("No bugs found", 1 <
				searchResultsPage.getAmountOfBugs());
	}
}
