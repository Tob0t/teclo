...
import at.scch.teclo.pageobjects.AddComponentPage;
import at.scch.teclo.pageobjects.AddProductPage;
...
public class BugzillaSetup {
	...
	public static int createExampleBug() {
		...
		// create bug
		CreateBugSelectProductPage createBugSelectProductPage = startPage.gotoCreateBugPage();
		CreateBugPage createBugPage = createBugSelectProductPage.setProduct("TestProduct");
	...
	public static AddProductPage gotoAddProductPage(){
		checkDriver();
		checkLogin();
		
		driver.get(baseUrl + "/editproducts.cgi?action=add");
	...
	public static void setTestConfig() {
		...
		// Teclo-04-Addproduct
		AddProductPage addProductPage = gotoAddProductPage();
		addProductPage.addProduct("Foo", "foo");
		
		AddComponentPage addComponentPage = gotoAddComponentPage("Foo");
		addComponentPage.addComponent("Bar", "bar", "admin");
