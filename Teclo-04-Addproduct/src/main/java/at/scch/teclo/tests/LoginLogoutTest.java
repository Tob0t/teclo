...
public class LoginLogoutTest extends AbstractBugzillaTest {
	...
	public void testLoginSuccessful() {
		...
		CreateBugSelectProductPage createBugSelectProductPage = loginPage.loginSuccessful("admin", "admin");
		
		assertTrue(createBugSelectProductPage.isLoggedin());
		assertEquals("admin", createBugSelectProductPage.getLoggedinUser());
		
		startPage = createBugSelectProductPage.logout();
