...
public abstract class AbstractBugzillaPage {
	...
	@FindBy(linkText = "View Comments Required on Status Transitions")
	private WebElement commentsRequiredOnStatusTransitionsLink;
	...
	public ConfigRequiredCommentsPage gotoConfigRequiredCommentsPage() {
		...
		commentsRequiredOnStatusTransitionsLink.click();
