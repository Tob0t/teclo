...
import at.scch.teclo.pageobjects.ConfigRequiredCommentsPage;
...
public class BugzillaSetup {
	...
	public static int createExampleBug() {
		...
		createBugPage.setSummary(exampleBugSummary);
		createBugPage.setComment("test data");
	...
	public static void setTestConfig() {
		...
		ConfigRequiredCommentsPage configRequiredCommentsPage = configRequiredSettingsPage.gotoConfigRequiredCommentsPage();
		configRequiredCommentsPage.updateCommentsRequiredOnStatusTransitions();
