...
import at.scch.teclo.pageobjects.ConfigProductPage;
import at.scch.teclo.pageobjects.ConfigRequiredSettingsPage;
import at.scch.teclo.pageobjects.ConfigWorkflowPage;
...
public class BugzillaSetup {
	...
	public static void setTestConfig() {
		...
		ConfigWorkflowPage configWorkflowPage = configRequiredSettingsPage.gotoConfigWorkflowPage();
		configWorkflowPage.setupSimpleBugWorkflow();
		
		ConfigProductPage configProductPage = configWorkflowPage.gotoConfigProductPage("TestProduct");
		configProductPage.updateVotesForProduct("1");
	...
	public static void resetTestConfig() {
		...
		ConfigWorkflowPage configWorkflowPage = configRequiredSettingsPage.gotoConfigWorkflowPage();
		// re-invoking setup resets page
		configWorkflowPage.setupSimpleBugWorkflow();
		
		ConfigProductPage configProductPage = configWorkflowPage.gotoConfigProductPage("TestProduct");
		configProductPage.updateVotesForProduct("0");
