...
public class CreateNewBugTest extends AbstractBugzillaTestWithLogin {
	...
	public void testCreateEmptyDescriptionResultsInError() {
		...
		ErrorCommentRequiredPage errorCommentRequiredPage = createBugPage.commitBugWithoutComment();
		
		assertEquals("You have to specify a description for this bug.", errorCommentRequiredPage.getErrorMsg());
	}
