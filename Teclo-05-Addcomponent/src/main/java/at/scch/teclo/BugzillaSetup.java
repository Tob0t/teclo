...
import at.scch.teclo.pageobjects.DeleteComponentPage;
...
public class BugzillaSetup {
	...
	public static DeleteComponentPage gotoDeleteComponentPage(String productName, String componentName) {
		checkDriver();
		checkLogin();
	...
	public static void setTestConfig() {
		...
		AddComponentPage addComponentPage = gotoAddComponentPage("TestProduct");
		addComponentPage.addComponent("SecondComponent", "Second test component", "admin");
	...
	public static void resetTestConfig() {
		...
		DeleteComponentPage deleteComponent = gotoDeleteComponentPage("TestProduct", "SecondComponent");
		assert "SecondComponent".equals(deleteComponent.getComponentName());
		deleteComponent.commitDeleteComponent();	
